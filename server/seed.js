...
const users = [
    { name: 'Admin User', email: 'admin@eventix.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@eventix.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@eventix.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@eventix.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@eventix.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@eventix.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@eventix.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@eventix.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@eventix.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventix.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventix.com');
        console.log('User Email:  user@eventix.com');
